...
/// Ohm law calculator.
/// </summary>
public class MCP16301 : Calculator {

    public MCP16301()
        : base("MCP16301 Voltage Regulator") {

        _InputVoltage = new Measurement(StoreRead(nameof(InputVoltage), 12), digitCount: 3, useSI: true, minValue: 0, maxValue: 30);
        ...
        _R1 = new Measurement(null, digitCount: -3, NumberSeries.E24, NumberSeriesRounding.Nearest);
        _R2 = new Measurement(StoreRead(nameof(R2), 10000), digitCount: -3, NumberSeries.E24, NumberSeriesRounding.Up, minValue: 0, maxValue: null);

        _L1 = new Measurement(null, digitCount: -3, NumberSeries.E24, NumberSeriesRounding.Nearest);
    ...
    private Measurement _L1;
    [Category("~Components")]
    [DisplayName("L1")]
    [MeasurementUnit("H")]
    public Measurement L1 {
        get { return _L1; }
    }
    ...
    private void Update() {
        _R1.Adjust(R2 * (DesiredVoltage * 1.005m / 0.8m - 1));
        _L1.Adjust(DesiredVoltage / 0.22m);
        _OutputVoltage.Adjust(0.8m * (1 + R1 / R2));
    }
    ...
    [Category("Input Voltages")]
    [DisplayName("30 V")]
    public void CmdInputVoltage300() { InputVoltage = 30; }
    ...
    [Category("Output Voltages")]
    [DisplayName("12 V")]
    public void CmdOutputVoltage120() { DesiredVoltage = 12; }


    [Category("Resistors")]
    [DisplayName("10 kΩ")]
    public void CmdR2() { R2 = 10000; }
    ...
    public override ReadOnlyCollection<string> GetElementNames() {
        return new ReadOnlyCollection<string>([
            ...
            nameof(R1), nameof(R2), nameof(L1),
            nameof(OutputVoltage),
            nameof(CmdInputVoltage033), nameof(CmdInputVoltage050), nameof(CmdInputVoltage090), nameof(CmdInputVoltage120), nameof(CmdInputVoltage240), nameof(CmdInputVoltage300),
            nameof(CmdOutputVoltage015), nameof(CmdOutputVoltage018), nameof(CmdOutputVoltage025), nameof(CmdOutputVoltage033), nameof(CmdOutputVoltage050), nameof(CmdOutputVoltage120),
            nameof(CmdR2),
            nameof(CmdRE24), nameof(CmdRE48), nameof(CmdRE96), nameof(CmdRE192),
        ]);
    }
